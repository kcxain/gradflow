...
class TensorTuple(Value):
    ...
    def __getitem__(self, index: int):
        return gradflow.ops.tuple_get_item(self, index)

    def tuple(self):
        return tuple([x for x in self])

    def __repr__(self):
        return "gradflow.TensorTuple" + str(self.tuple())
    ...
    def __add__(self, other):
        ...
        return gradflow.ops.make_tuple(
...
class Tensor(Value):
    ...
    def __repr__(self):
        return "gradflow.Tensor(" + str(self.realize_cached_data()) + ")"
    ...
    def __add__(self, other):
        if isinstance(other, Tensor):
            return gradflow.ops.EWiseAdd()(self, other)
        else:
            return gradflow.ops.AddScalar(other)(self)

    def __mul__(self, other):
        if isinstance(other, Tensor):
            return gradflow.ops.EWiseMul()(self, other)
        else:
            return gradflow.ops.MulScalar(other)(self)
    ...
    def __pow__(self, other):
        ...
        if isinstance(other, Tensor):
            ...
            return gradflow.ops.PowerScalar(other)(self)

    def __sub__(self, other):
        if isinstance(other, Tensor):
            return gradflow.ops.EWiseAdd()(self, gradflow.ops.Negate()(other))
        else:
            return gradflow.ops.AddScalar(-other)(self)

    def __truediv__(self, other):
        if isinstance(other, Tensor):
            return gradflow.ops.EWiseDiv()(self, other)
        else:
            return gradflow.ops.DivScalar(other)(self)

    def __matmul__(self, other):
        return gradflow.ops.MatMul()(self, other)

    def matmul(self, other):
        return gradflow.ops.MatMul()(self, other)

    def sum(self, axes=None):
        return gradflow.ops.Summation(axes)(self)

    def broadcast_to(self, shape):
        return gradflow.ops.BroadcastTo(shape)(self)

    def reshape(self, shape):
        return gradflow.ops.Reshape(shape)(self)

    def __neg__(self):
        return gradflow.ops.Negate()(self)

    def transpose(self, axes=None):
        return gradflow.ops.Transpose(axes)(self)
